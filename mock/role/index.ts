...
const testList: string[] = [
  ...
  '/accountant/accounts-approval',
  '/accountant/accounts-approval/user-account',
  '/accountant/accounts-approval/collaborator-account',
  '/accountant/accounts-approval/internal-account',
  '/accountant/approve-promotion-strategy',

  '/accountant/approve-promotion-strategy/approve-flashsale',
  '/accountant/approve-promotion-strategy/approve-collection',
  '/accountant/approve-promotion-strategy/approve-newproduct',
  '/accountant/approve-promotion-strategy/approve-voucher',
  '/accountant/approve-promotion-strategy/approve-combo',
  '/accountant/approve-promotion-strategy/approve-auction',
  '/accountant/approve-promotion-strategy/approve-advertisingBanner',

  '/accountant/approve-management',
