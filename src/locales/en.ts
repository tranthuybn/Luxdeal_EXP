export default {
  ...
  formDemo: {
    ...
    depositTerm: 'Depossit term',
    atLeast14Days: 'At least 14 Days',
    atLeast10Days: 'At least 14 Days',
    lessThan10Records: 'Less than 10 record',
    listOfConsignmentProducts: 'Lisr of consigment product',
    negotiablePrice: 'Negottiable price',
    orderValue: 'Order value',
    depositFee: 'Despsit fee',
    payableFees: 'Payable fee',
    businessManagement: 'Business management',
    serviceTrackingTable: 'Service tracking table',
    importTrackingTable: 'Import tracking table',
    pawnTerm: 'Pawn term',
    pawnFeePaymentTime: 'Pawm fee Payment time',
