export default {
  common: {
    ...
    cancel: 'Hủy bỏ',
    reload: 'Tải lại',
    closeTab: 'Đóng các trang tab',
    closeTheLeftTab: 'Tắt trang nhãn bên trái',
    closeTheRightTab: 'Tắt trang tab bên phải',
    closeOther: 'Tắt các trang tab khác',
    closeAll: 'Tắt tất cả các trang tab',
    prevLabel: 'Trước',
  ...
  workplace: {
    ...
    toDo: 'Sắp tới',
    introduction: 'Một hồ sơ nghiêm túc',
    more: 'Hơn',
    shortcutOperation: 'Hoạt động nhanh chóng',
    operation: 'Vận hành',
    index: 'Mục lục',
    personal: 'Riêng tư',
    team: 'Đội',
    quote: 'Trích dẫn',
    contribution: 'Góp phần',
    hot: 'Nhiệt',
    yield: 'Năng suất',
    dynamic: 'Năng động',
    push: 'Đẩy',
    pushCode: 'Archer Mã đẩy GitHub',
