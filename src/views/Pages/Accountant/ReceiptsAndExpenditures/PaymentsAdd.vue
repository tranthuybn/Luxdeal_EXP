...
const type = router.currentRoute.value.params.type ?  String(router.currentRoute.value.params.type) : 'add'
...
const schema = reactive<FormSchema[]>([
  {
    ...
    label: t('formDemo.paymentVoucherInformation'),
    component: 'Divider'
  },
  {
    field: 'code',
    label: t('formDemo.codePayment'),
    component: 'Input',
    colProps: {
      span: 24
    },
...
const collapse: Array<Collapse> = [
  {
    ...
    title: t('reuse.paymentAddDetails'),
    columns: schema
  }
]
