...
const getListOrder = async () => {
  try {
    const res = await getOrderApproval({ pageIndex: 1, pageSize: 20 })
...
<template>
  <div class="bg-white p-4 font-bold text-lg">
    ...
    <el-table :data="tableListOrder" border style="width: 100%">
      ...
      <el-table-column prop="orderCode" :label="t('formDemo.orderCode')" width="100" />
      <el-table-column prop="orderType" :label="t('formDemo.orderType')" />
