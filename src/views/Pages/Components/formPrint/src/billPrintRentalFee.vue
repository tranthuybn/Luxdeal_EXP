      ...
      <div class="basis-5/12 flex flex-col justify-between">
        ...
        <div v-else>
          ...
          <div class="deposit flex justify-between text-[#409eff]">
            ...
            <div v-if="dataEdit">{{currencyFormatter.format(getArraySumdepositePrice(dataEdit.orderDetails))  }}</div>
          </div>
          <div class="deposit flex justify-between text-[#f56c6c]">
            <div class="text-[20px]">{{ t('router.cashReturn') }}</div>
            <div v-if="dataEdit">{{currencyFormatter.format(getArraySum(dataEdit.orderDetails ) - getArraySumdepositePrice(dataEdit.orderDetails))  }}</div>
          </div>
        </div>
      </div>
    </div>
