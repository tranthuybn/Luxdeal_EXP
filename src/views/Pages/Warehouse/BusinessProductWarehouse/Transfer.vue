...
const collapse: Array<Collapse> = [
  {
    ...
    title: t('reuse.profileTransfer')
  },
  {
    icon: plusIcon,
    name: 'importedProductsWareHouse',
    title: t('reuse.importedProductsTransfer')
  }
]
    ...
    <el-collapse v-model="activeName" @change="collapseChangeEvent">
        ...
        <div class="flex w-[100%]">
          <div class="w-[50%]">
            <ElForm
              ...
              status-icon
            >
              <el-divider content-position="left">{{ t('reuse.profileTransfer') }}</el-divider>
      ...
      <el-collapse-item :name="collapse[1].name">
        ...
        >
          ...
          <el-table-column :label="t('reuse.importExportWarehouse')" min-width="200">
          ...
          <el-table-column
            prop="price"
            :label="t('formDemo.unitPriceTransfer')"
            align="right"
            width="180"
          >
            <template #default="props">
          ...
          <el-table-column
            prop="finalPrice"
            :label="t('formDemo.intoMoneyTransfer')"
            align="right"
            width="180"
          />
        ...
        <div class="ml-[170px]">
          <ElButton class="w-[150px]">{{ t('reuse.printTransferSlip') }}</ElButton>
          <ElButton class="w-[150px]" type="primary">{{ t('reuse.save') }}</ElButton>
          <ElButton class="w-[150px]" type="primary">{{ t('reuse.moveWarehouseNow') }}</ElButton>
          <ElButton class="w-[150px]" type="danger">{{ t('reuse.cancelTransfer') }}</ElButton></div
        >
      </el-collapse-item>
    </el-collapse>
  </div>
